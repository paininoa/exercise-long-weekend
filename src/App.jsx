...
Bonus:
Crea una React APP in cui l'utente inserisce i dati di un form, attraverso un componente CustomFormElement, che in base al props 'mode' ("input", "select", "checkbox", "radio") ritorna il form element corrispondente (potete usare uno switch, come visto oggi a lezione).
